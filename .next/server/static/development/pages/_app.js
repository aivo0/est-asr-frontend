...
})(["font-family:\"Monserrat\";font-size:4rem;margin-right:1rem;position:relative;z-index:2;margin-block-start:0;margin-block-end:0;a{padding:0.5rem 1rem;color:", ";text-underline-position:uppercase;text-decoration:none;}@media (max-width:600px){margin:0;text-align:center;}"], function (props) {
...
/*!*******************!*\
  !*** ./config.js ***!
  \*******************/
/*! exports provided: endpoint, wssEndpoint */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var endpoint = "http://localhost:4000"; //export const prodEndpoint = `https://_.herokuapp.com/`;

var wssEndpoint = "ws://localhost:4000"; //export const prodWssEndpoint = `ws://localhost:4000`
